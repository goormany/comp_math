...
int main() {
    ...
    cout << "1 - Hilbert (ill-conditioned)\n";
    cout << "2 - Random (moderately conditioned)\n";
    cout << "3 - Tridiagonal (well-conditioned)\n";
    cout << "Your choice: ";
    cin >> type;
    ...
    cout << "Matrix and vector have been written to input.txt\n";
    return 0;
}
