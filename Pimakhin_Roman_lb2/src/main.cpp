...
int main() {
    ...
    if (!success) {
        cerr << "Gaussian elimination: matrix is singular or nearly singular" << endl;
        return 1;
    }
    ...
    if (info != 0) {
        cerr << "LAPACK: solution error (info = " << info << ")" << endl;
        return 1;
    }
    ...
    cout << "System size: " << n << "\n";
    cout << "Gaussian method time: " << duration_gauss << " microseconds\n";
    cout << "LAPACK (dgesv) time: " << duration_lapack << " microseconds\n";
    cout << "Relative residual (Gauss): " << scientific << relres_gauss << "\n";
    cout << "Relative residual (LAPACK): " << scientific << relres_lapack << "\n";
    cout << "Gauss solution error relative to LAPACK (Euclidean norm): " << scientific << err << "\n";
    ...
    cout << "Solution saved to solution.txt\n";
